...
#Order factors where appropriate
OFB_wide_factor$q025 <- factor(OFB_wide_factor$q025, levels=c("18-20",
                      "21-30",
                      "31-40",
                      "41-50",
                      "51-60",
...
OFB_wide_factor$q009 <- factor(OFB_wide_factor$q009, levels=c("Less Than 1 Year Ago",
                     "1 To 2 Years Ago",
                     "3 To 4 Years Ago",
                     "5 To 10 Years Ago",
                     "More Than 10 Years Ago",
                     "Prefer Not To Answer"), ordered = TRUE)


OFB_wide_factor$q037<- factor(OFB_wide_factor$q037, levels=c(
                     "Less Than 1 Year",
                     "1-4 Years",
                     "5-9 Years",
                     "10 Or More Years",
                     "Canadian Born",
                     "Prefer Not To Answer",
                     "Not Applicable"), ordered = TRUE)

OFB_wide_factor$q010<- factor(OFB_wide_factor$q010, levels=c("Less Than 1 Year Ago",
...
OFB_wide_factor$q013<- factor(OFB_wide_factor$q013, levels=c("Don't Visit Every Month",
            "One",
            "2 To 3",
            "More Than 4",
            "None Of The Above",
